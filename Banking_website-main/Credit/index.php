...
<div id="header">
       <br>
       <h1 style=" font-family:Agency FB; font-size: 70px  ; color :green;"> Sparks Foundation Internship Project </h1>
       <br>
       <h2 style=" font-family:Agency FB; font-size: 55px  ;color :green; "> Credit management </h2>
        </div>
        <div id="section">
            <table>
                <tr></tr>
